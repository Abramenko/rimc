...
module CssSprite
  ...
  def self.do(task_list, controller)
    begin
      print "#{task_list.current_task}: Started doing css sprite... It may take several minutes |"
...
# Foundation  
      ...
      puts "#{task_list.current_task}: ERROR(css_sprite.rb): Something went wrong...Check the spelling of \"config.yaml\" "
